...
from .views import DoctorAPIView, DoctorUpdateAPIView, PatientUpdateAPIView, ProfileUpdateView, SymptomAPIView, UserRegistrationAPIView, PatientAPIView, AppointmentAPIView
